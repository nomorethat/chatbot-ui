...
def create_ui():
    ...
    with gr.Tab("Session", elem_id="session-tab"):
        ...
        shared.gradio['reset_interface'].click(
            ...
            lambda: None, None, None, _js='() => {document.body.innerHTML=\'<h1 style="font-family:monospace;padding-top:20%;margin:0;height:100vh;color:lightgray;text-align:center;background:#fafbfc">Reloading...</h1>\'; setTimeout(function(){location.reload()},2500); return []}')
